...
Page({
      ...
      async getList() {
        // console.log("getList");
            ...
            try{
              const res = await request("/favorite/my",{},"GET");
              wx.hideLoading();
              ...
              for (let i = 0; i < res.data.length; i++) {
                ...
                app.dataList[2].push(res.data[i]);
            ...
            wx.showModal({
                  ...
                  async success(res) {
                        if (res.confirm) {
                              ...
                              try{
                                  const res = await request('/favorite/delete',{id:col.id},'GET')
                                  wx.hideLoading();
                                          wx.showToast({
                                                title: '取消成功',
                                          })
      ...
      detail(e) {
            ...
            wx.navigateTo({
              url: '/pages/detail/detail?scene=' + detail.idleId,
            })      
